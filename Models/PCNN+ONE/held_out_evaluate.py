...
def held_out_evaluation(test_loader, model, opt):
    ...
    with torch.no_grad():
        for i, data in enumerate(tqdm(test_loader)):
            ...
            token_idxes, att_masks, pos1es, pos2es, pos_masks, labels = data
            out = model(token_idxes, att_masks, pos1es, pos2es, pos_masks)
...
if __name__ == '__main__':
    opt = Config()
    model_name = "model_2022_11_07_10_24_37.ckpt"
